...
nt= [100 300]; n_interv = 100;

    

dT=[0];
Temperi = [551.1];
Tempere = [553];  %% Temperature of Tc
Tm0 = 0; %% Temperature difference T_ref and Tm
Temper_interv = 0.1;
temper_en = 1;
Temper_factor = 0;
dT=[Temperi(1)];
...
% Vibration
Da = sort(Da); freq = sort(freq);
disp(Da(1))


Da_k(int64((Temper-Temperi(1))/Temper_interv)+1,int64((step-nt(1))/n_interv)+1) = Da(1);
freq_k(int64((Temper-Temperi(1))/Temper_interv)+1,int64((step-nt(1))/n_interv)+1) = freq(1);
